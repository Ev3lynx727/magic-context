            ...
            historian: {
                ...
                properties: {
                    ...
                    two_pass: {
                        ...
                        default: false,
                        description:
                            "Run a second editor pass over historian output to clean low-signal U: lines and cross-compartment duplicates. Adds ~1 extra API call per historian run. Useful for models without extended thinking support.",
                    },
                    thinking_level: {
                        type: "string",
                        enum: ["off", "minimal", "low", "medium", "high", "xhigh"],
                        description:
                            "Pi only: explicit thinking level passed as --thinking <level> to Pi historian subagent invocations. Required for providers like GitHub Copilot that may apply bad defaults. OpenCode users set variant instead.",
                    },
                },
                additionalProperties: false,
                description: "Historian agent configuration (model, fallback_models, variant, two_pass, thinking_level, etc.)",
            },
                    ...
                    user_memories: {
                        ...
                        properties: {
                            enabled: {
                                ...
                                default: true,
                                description:
                                    "Extract user behavior observations from historian runs and promote recurring patterns to stable user memories injected into all sessions.",
                            },
                            promotion_threshold: {
                                type: "number",
                                minimum: 2,
                        ...
                        description: "User memory pipeline configuration",
                    },
                    pin_key_files: {
                        type: "object",
                        properties: {
                            enabled: {
                                ...
                                default: false,
                                description:
                                    "Pin frequently-read key files into the system prompt. Dreamer identifies key files per session based on read patterns.",
                            },
                            token_budget: {
                                type: "number",
                                minimum: 2000,
                        ...
                        description: "Key file pinning configuration",
                    },
                    thinking_level: {
                        type: "string",
                        enum: ["off", "minimal", "low", "medium", "high", "xhigh"],
